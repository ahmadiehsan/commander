...
class CommanderRun:
    ...
    def __init__(
        ...
        def null_function_topic_class(topic_class):  # pylint: disable=unused-argument # noqa
            pass

        def null_function_action_class(action_class):  # pylint: disable=unused-argument # noqa
            pass

        def null_function_action_obj(action_obj):  # pylint: disable=unused-argument # noqa
            pass
    ...
    def run(self):
        ...
        try:
            ...
            print(f'Stopped at "before_run_action_hook": {str(err)}')
            sys.exit()
        ...
        try:
            ...
            print(f'Stopped at "after_run_action_hook": {str(err)}')
            sys.exit()
    ...
    def _get_topic_class(topic_name):
        ...
        try:
            ...
            print(f'Please add the "Topic" class to "__init__.py" of "{topic_name}" topic')
            sys.exit()
